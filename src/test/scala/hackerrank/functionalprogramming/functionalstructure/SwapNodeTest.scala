...
import hackerrank.functionalprogramming.functionalstructures.SwapNodes
import hackerrank.functionalprogramming.functionalstructures.SwapNodes.model._
import hackerrank.functionalprogramming.functionalstructures.data.SwapNodeInputs
